...
assert.ok(build.includes('versionCode 13'), 'Android Alpha-2 test build must increment the installable version code')
assert.ok(build.includes('versionName "Alpha-2"'), 'Android test build must expose version Alpha-2')
