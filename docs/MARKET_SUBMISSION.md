...
## Generated Release Artifacts (preview build, 2026-07-31)

The following source-matched packages were generated by `npm run release:watch` for the `preview` channel. The script unpacked every `.zab` and verified `manifest.json` version `1.1.1` / code `18` and the listed `deviceSource` values before publishing `dist/`. The complete machine-readable record is `dist/RELEASE_MANIFEST.json`; `dist/SHA256SUMS.txt` covers every package and the manifest.

| Device package | `deviceSource` | SHA-256 |
| --- | --- | --- |
| `RingMap-ZeppOS-1.1.1-balance-8519936-8519937-8519939.zab` | 8519936, 8519937, 8519939 | `538ebacea155f3c702d5c9dd83375f9a1863688bb7e642c164f64846cfd93216` |
| `RingMap-ZeppOS-1.1.1-cheetahpro-8126720-8126721.zab` | 8126720, 8126721 | `aba4d22ed85ce66350e0cb958f9ea7820fcefbe6e4124f069885b61c7a38cf2c` |
| `RingMap-ZeppOS-1.1.1-active2-8913152-8913153-10092800-10092801.zab` | 8913152, 8913153, 10092800, 10092801 | `e502b6217ac0af1b129b66459eab525daafe3eea71e6d61d609152f45c8914f7` |
| `RingMap-ZeppOS-1.1.1-active2-8913155-8913159-10092803-10092807.zab` | 8913155, 8913159, 10092803, 10092807 | `3ac01e42765f3d15b9f4725de1442a24f955fca73b286c3ae39056affe529c6a` |
| `RingMap-ZeppOS-1.1.1-trex3-pro-10551552-10551553-10551555.zab` | 10551552, 10551553, 10551555 | `85531f4f801748e9478976ff2dce2824392134994e74ec9b37917c60ff1cca0c` |
| `RingMap-ZeppOS-1.1.1-gtr4-7930112-7930113.zab` | 7930112, 7930113 | `086766aa7ce317903c9ad4fbb8eb6d480eb7d496feb9406f54c4daf2ae0564d6` |
| `RingMap-ZeppOS-1.1.1-gtr4-7864577.zab` | 7864577 | `665648b2a5f74d21de3e6bcac8af2394d2e5b429bbbdcf384de020f2c41e9d99` |
| `RingMap-ZeppOS-1.1.1-trex3-8716544-8716545-8716547.zab` | 8716544, 8716545, 8716547 | `1177fbd0e44a4bb6a72c01029e6b250614d50bb0be1aa1ca103aeef8a3e35921` |

Android preview companion artifact: `dist/RingMap-Android-Alpha-2-preview-debug.apk`
...
| SHA-256 | `7bd2344dbbd66bec4bc1c4683e978384aec51fa58f35f1a0f7d29719da2b42fc` |
